...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'account.last_login': '最後登入',
    'account.email': '電子信箱',
    'account.username': '使用者名稱',
    'account.username_placeholder': '輸入英文與數字組合',
    'account.username_hint': '僅支援英文字母與數字',
    'account.username_available': '此名稱可使用',
    'account.username_taken': '此名稱已被使用',
    'account.username_invalid': '僅支援英文字母與數字',
  ...
  en: {
    ...
    'account.username_placeholder': 'Enter letters and numbers',
    'account.username_hint': 'Letters and numbers only',
    'account.username_available': 'Username is available',
    'account.username_taken': 'Username is already taken',
    'account.username_invalid': 'Letters and numbers only',
