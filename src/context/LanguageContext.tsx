...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'admin.confirm_remove_title': '確定移除用戶？',
    'admin.confirm_remove': '此操作將從系統中移除該用戶的 Profile 資料，此操作無法復原。',
    'common.delete': '確認刪除',
    'common.cancel': '取消',
  ...
  en: {
    ...
    'admin.confirm_remove_title': 'Confirm User Removal?',
    'admin.confirm_remove': 'This action will remove the user profile from the system. This cannot be undone.',
    'common.delete': 'Delete User',
