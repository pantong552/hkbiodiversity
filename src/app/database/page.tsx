...
export async function generateMetadata(props: { 
  ...
  const defaultTitle = 'Species Database | 物種資料庫 | HK Biodiversity Collective';
  const defaultDescription = 'Explore our comprehensive biodiversity database of Hong Kong, covering approximately 10,000 species.';
  ...
  const canonicalUrl = `${baseUrl}/database?species=${speciesId}`;

  const dynamicTitle = `${commonName} (${scientificName}) | Species Database | HKBC`;
