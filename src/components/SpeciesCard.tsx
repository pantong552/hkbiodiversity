...
export default function SpeciesCard({ 
  ...
  return (
    <div 
      ...
      className={`
        group relative bg-white border border-slate-200/50 shadow-[0_2px_10px_rgba(0,0,0,0.06)]
    ...
    >
      ...
      <div className={`relative overflow-hidden bg-slate-100 transition-colors duration-500 ${isPhoto ? 'h-40 sm:h-48 rounded-2xl' : 'h-48 rounded-t-[1.5rem]'} ${isPlaceholder ? 'bg-slate-50' : 'bg-slate-100'}`}>
      ...
      {!isPhoto ? (
        <div className="p-3 bg-white flex flex-col gap-2 rounded-b-[1.5rem]">
